...
class Solution(object):
    def twoSum(self, nums, target):
        ...
        for i, num in enumerate(nums):
            ...
            hmap_value: int = hmap.get(target_element)
            if hmap_value is not None:
                output_list.append(i)
                output_list.append(hmap_value)
                return output_list
            else:
                hmap[num] = i
           
        return output_list # should never get to this, but just in case
